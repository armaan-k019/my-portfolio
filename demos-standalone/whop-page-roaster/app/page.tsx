...
function CopyButton({ text, label = "Swipe Copy", c }: { text: string; label?: string; c: PageColors }) {
  ...
  return (
    <button
      ...
      style={{
        borderColor: copied ? "#22c55e" : c.accent,
        color: copied ? "#22c55e" : c.accent,
...
export default function WhopPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      const res = await fetch("https://armaankazi.com/api/demos/whop", {
        method: "POST",
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: BG, color: C.text }}>
      {/* ── Header ── */}
        ...
        <div className="w-full max-w-[860px] mx-auto flex items-start justify-between gap-4 flex-wrap">
          ...
          <div className="flex flex-col items-end gap-1.5">
            <span className="text-xs mt-1" style={{ color: C.dim }}>
              Demo by{" "}
              <a href="https://armaankazi.com" className="hover:text-gray-400 underline transition-colors" style={{ color: C.muted }}>
                Armaan Kazi
              </a>
            </span>
          </div>
      ...
      <div className="w-full max-w-[860px] mx-auto px-6 py-10" style={{ minWidth: 0 }}>
        ...
        {/* ── Section A: What Whop does today ── */}
            ...
            <div className="space-y-2">
              {LOADING_LINES.slice(0, loadingLine + 1).map((line, i) => (
                <p
                  ...
                  style={{
                    color: i === loadingLine ? PURPLE : C.dim,
                    opacity: i === loadingLine ? 1 : 0.5,
                  }}
                >
                  {i === loadingLine && (
          ...
          <div ref={resultsRef} className="space-y-6">
            ...
            >
              ...
              <div
                ...
                style={{ color: GRADE_COLOR[result.overall_grade], fontSize: "120px", marginBottom: "28px" }}
              >
                ...
                {result.dimensions.map((dim, i) => (
                  ...
                  >
                    ...
                    <div
                      ...
                      style={{ backgroundColor: "#0a0a0a", borderColor: BORDER, padding: "14px 16px" }}
                    >
            ...
            >
              <div className="px-6 py-5 border-b" style={{ borderColor: PURPLE + "30" }}>
                <h2 className="text-lg font-black tracking-tight">✍️ The Rewrite Lab</h2>
                ...
                <div style={{ padding: "28px 28px" }}>
                  ...
                  <div className="rounded-xl border" style={{ backgroundColor: "#0a0a0a", borderColor: BORDER, padding: "20px", marginBottom: "16px" }}>
                    <div style={{ marginBottom: "16px" }}>
                      ...
                      <p className="line-through" style={{ color: "#4b5563", fontSize: "13px", opacity: 0.6 }}>
                        {result.headline_original}
                      </p>
                    </div>
                    <div style={{ borderTop: `1px solid ${BORDER}`, paddingTop: "16px" }}>
                      ...
                      <p className="font-black leading-snug" style={{ fontSize: "20px" }}>{result.headline_rewrite}</p>
                    </div>
                  </div>
            ...
            {hasAffiliate && (
              ...
              >
                ...
                <div className="space-y-4 mb-6">
                  ...
                  <div
                    className="rounded-lg p-4 border"
                    style={{ backgroundColor: "#0a0a0a", borderColor: PURPLE + "40" }}
                  >
                  ...
                  <div className="space-y-3">
                    {result.affiliate_pitch_lines.map((line, i) => (
                      <div
                        key={i}
                        className="rounded-lg border"
                        style={{ backgroundColor: "#0a0a0a", borderColor: BORDER, padding: "16px" }}
                      >
                        <p className="leading-relaxed" style={{ color: "#d1d5db", fontSize: "14px", marginBottom: "12px" }}>
                          &ldquo;{line}&rdquo;
                        </p>
                        <CopyButton text={line} c={C} />
                      </div>
                    ))}
                  </div>
                </div>
            ...
            {/* ── 5. One Thing ── */}
            <div
              className="rounded-2xl border text-center px-6 py-10 sm:px-8 sm:py-14"
              style={{ backgroundColor: "#0d0d1a", borderColor: PURPLE + "40" }}
            >
              ...
              <p
                ...
                style={{ color: PURPLE, fontSize: "22px", marginBottom: "40px" }}
              >
                {result.one_thing}
              </p>
      ...
      <footer className="border-t px-6 py-6 text-center" style={{ borderColor: BORDER }}>
        <p className="text-xs leading-relaxed" style={{ color: "#374151" }}>
          ...
          Built by{" "}
          <a href="https://armaankazi.com" className="hover:text-gray-500 underline transition-colors">
            Armaan Kazi
          </a>{" "}
