...
export default function WeavePage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      const res = await fetch("https://armaankazi.com/api/demos/weave", {
        method: "POST",
        ...
        <div className="max-w-5xl mx-auto flex items-start justify-between gap-4 flex-wrap">
          ...
          <div className="flex flex-col items-end gap-1.5 flex-shrink-0">
            <span className="text-xs" style={{ color: C.headerText + "99" }}>
              Demo by{" "}
              <a href="https://armaankazi.com" className="hover:underline transition-colors" style={{ color: C.headerText }}>
                Armaan Kazi
              </a>
            </span>
          </div>
      ...
      >
        <div className="max-w-5xl mx-auto text-center space-y-1">
          ...
          <p className="text-xs" style={{ color: C.dim }}>
            Built by{" "}
            <a href="https://armaankazi.com" className="hover:text-gray-500 transition-colors">Armaan Kazi</a>
