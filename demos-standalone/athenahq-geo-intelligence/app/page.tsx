...
export default function AthenaHQPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      const lib = await callApi<PromptLibrary>("https://armaankazi.com/api/demos/athena-hq/prompts", {
        brand: form.brand,
      ...
      const sov = await callApi<SovResult>("https://armaankazi.com/api/demos/athena-hq/sov", {
        brand: form.brand,
        competitors,
        prompts: sovPrompts,
      });
      ...
      await step(4, 300);
      const citation = await callApi<CitationResult>("https://armaankazi.com/api/demos/athena-hq/citation", {
        brand: form.brand,
        competitors,
      ...
      const briefData = await callApi<ContentBrief[]>("https://armaankazi.com/api/demos/athena-hq/briefs", {
        brand: form.brand,
        industry: form.industry,
      ...
      <header className="px-6 py-4" style={{ backgroundColor: C.headerBg, borderBottomColor: C.headerBorder }}>
        <div className="max-w-5xl mx-auto flex items-start justify-between gap-4 flex-wrap">
          <div>
            ...
            <p className="text-xs leading-relaxed max-w-2xl" style={{ color: "rgba(255,255,255,0.55)" }}>
          ...
          <div className="flex flex-col items-end gap-1.5 flex-shrink-0">
            <span className="text-xs" style={{ color: "rgba(255,255,255,0.30)" }}>
              Demo by{" "}
              <a href="https://armaankazi.com" className="underline transition-colors hover:opacity-80" style={{ color: "rgba(255,255,255,0.30)" }}>
                Armaan Kazi
              </a>
            </span>
          </div>
      ...
      <footer className="border-t px-6 py-8 mt-10" style={{ borderColor: C.cardBorder, backgroundColor: C.cardBg }}>
        <div className="max-w-5xl mx-auto text-center space-y-2">
          ...
          <p className="text-xs" style={{ color: C.dim }}>
            Built by{" "}
            <a href="https://armaankazi.com" className="transition-colors hover:opacity-80" style={{ color: C.muted }}>
              Armaan Kazi
            </a>
