...
export const PRELOADED_TEXTS: PreloadedText[] = [
  {
    ...
    excerpt: "The universe (which others call the Library) is composed of an indefinite, perhaps infinite number of hexagonal galleries. In the center of each gallery is a ventilation shaft, bounded by a low railing. From any hexagon one can see the floors above and below—one after another, endlessly. The arrangement of the galleries is always the same: Twenty bookshelves, five to each side, line four of the hexagon's six sides; the height of the bookshelves, floor to ceiling, is hardly greater than the height of a normal librarian. One of the hexagon's free sides opens onto a narrow sort of vestibule, which in turn opens onto another gallery, identical to the first—identical in fact to all. To the left and right of the vestibule are two tiny compartments. One is for sleeping, upright; the other, for satisfying one's physical necessities.",
    attribution_notes: "Fair use excerpt: the first seven sentences of the opening paragraph of a roughly 3,000 word story, quoted from the published Hurley translation for commentary and interpretation. Trimmed at a sentence boundary so the reading fits the extraction budget; punctuation unchanged. The Spanish original was first published in El jardin de senderos que se bifurcan, 1941.",
    word_count: 139,
  },
  {
    id: "diomira",
